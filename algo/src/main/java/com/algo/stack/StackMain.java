...
public class StackMain {
   private static ArrayList<String> symbol = new ArrayList(Arrays.asList(new String[]{"+","-","*","/","(",")"}));
    //将字符串中数字和符号拆除来，放进列表中
    ...
    public static boolean priority(String one,String two){
    ...
    //前缀表达式转后缀表达式
    public static ArrayList<String> prefixToSuffix(ArrayList<String> prefix_list){
    ...
    //计算后缀表达式
    public static double cal(ArrayList<String> list){
        Stack<String> stack = new Stack<String>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String> expList = split(expression);
        System.out.println("分解字符串 : "+expList);
        ArrayList<String> suffix_list = prefixToSuffix(expList);
        System.out.println(suffix_list);
        System.out.println(cal(suffix_list));
    }
}
